    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST, "/api/v1/customer").hasAuthority("USER_DETAILS_WRITE")
                        .requestMatchers(HttpMethod.PATCH, "/api/v1/customer/{ID}").hasAuthority("USER_DETAILS_WRITE")
                        .requestMatchers(HttpMethod.GET, "/api/v1/customer").hasAuthority("USER_DETAILS_READ")
                        .requestMatchers(HttpMethod.GET, "/api/v1/customer/all").hasAuthority("USER_DETAILS_READ")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/customer").hasAuthority("USER_DETAILS_DELETE")
